...
//    }
    ...
    private LocalDateTime parseDate(String value, String format) {
        ...
        map.put(DateUtils.YEAR_SYMBOL, 0);
        map.put(DateUtils.MONTH_SYMBOL, 1);
        map.put(DateUtils.DAY_SYMBOL, 1);
        map.put(DateUtils.HOUR_SYMBOL, 0);
        map.put(DateUtils.MINUTE_SYMBOL, 0);
        map.put(DateUtils.SECOND_SYMBOL, 0);
        if (m.matches()) {
